...
public class Game extends AppCompatActivity {
    ...
    public boolean check(int a, int b, ImageView i, String j) {
        ...
        //if the piece can't be placed return false
        else {
            //no size was chosen
    ...
    //dialog box to inform user they used up their pieces
    ...
    //alert dialog shows up if a player wins or there is a tie
